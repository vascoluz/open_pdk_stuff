...
plot v(VOUT) (v(VB)-v(VIN)) deriv(v(VOUT)) (v(VOUT)-v(VIN))
plot i(Vmeas) 
plot deriv(v(VOUT))
tran 10ns 20u
plot (v(VOUT)-2.083) (v(VIN)-1.2)
...
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=1.2}
...
C {devices/lab_pin.sym} -80 -430 0 0 {name=p3 sig_type=std_logic lab=VB
}
...
C {devices/vsource.sym} -80 -350 0 0 {name=V4 value=3}
C {devices/gnd.sym} -80 -290 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} 180 -450 0 0 {name=p6 sig_type=std_logic lab=VIN}
C {devices/lab_pin.sym} 430 -70 0 0 {name=p7 sig_type=std_logic lab=VIN}
